...
public class PermissionController {
    ...
    public String addView(HttpServletRequest request, Model model) {
        ...
        if (!"0".equals(parentId)) {
            SysPermission permission = permissionService.getPermissionById(Integer.valueOf(parentId));
    ...
    public String updateView(HttpServletRequest request, Model model) {
        ...
        SysPermission permission = permissionService.getPermissionById(Integer.valueOf(id));
        model.addAttribute("permission", permission);
